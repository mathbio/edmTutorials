...
forecatsing and learn details about the rEDM library in the introductory
...
Surprisingly, it is possible to recover the rules that govern a dynamical system using the time series 
(*i.e.* sequence of observations) of a single variable of the system. 
Takens Theorem tells us that there is a simple way to recover the properties of a dynamical 
...
time for forecast?
To check this run the commands below 
