...
We are going to use the nearest neighbours of x(70) within the manifold Mx to predict y(70). To do this, we first create a matrix of distances among the states of Mx and then we select the three nearest neighbours within the Mx. It is important to notice that the number of neighbours is based on the optimal embedding (E*+1 = 3). 
...
This is better visualized in the plot below.
