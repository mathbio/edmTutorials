...
Now that we have the optimal embeddings, we can construct the lagged-coordinates MX and MY using the make_block from rEDM package. Use this command to download the function code and load it in your 
R workspace:
