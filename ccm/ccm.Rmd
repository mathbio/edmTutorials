...
How can we extract this causality from the coupled dynamics?
As we have seen in a previous section, a generic property of lagged-coordinate embedding is that points x(t) on MX map 1:1 to points m(t) on M and local neighborhoods on Mx map to local neighborhoods on M. 
