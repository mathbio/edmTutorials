...
How can we then extract this causality from the coupled dynamics?
As we have seen in previous sections, a generic property of lagged-coordinate embedding is that points of X(t) on the Mx map maps one-to-one to points m(t) on M and local neighborhoods on Mx map to local neighborhoods on M. 
**MARINA: DEFINE M, m(t), and be consistent regarding 'MX' and 'Mx'**
...
**MARINA: what do you mean by contemporaneous?**
