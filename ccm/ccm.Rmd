...
Now that we have the optimal embeddings, we can construct the shadow manifolds Mx and My using the make_block function from rEDM package. Use this command to download the function code and load it in your
