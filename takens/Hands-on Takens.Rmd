...
space as we see above, but by using Takens theorem tells us that we
...
is the **embedding** of  a **shadow manifold** of the atractor. 
This shadow manifold is a valid topological reconstruction of the
attractor. 
