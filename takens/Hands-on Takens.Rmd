...
This tutorial presents the general idea of Convergent Cross Mapping (Ye *et al.* 2017), then it shows some practical examples using syntetic data. In the last session there is a real data analysis proposed as exercise.
